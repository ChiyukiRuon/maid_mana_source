...
| `maxPerCharge`           | int     | `1000`  | Maximum mana amount added to a source jar per charge              |
...
| `favorCooldownReduction` | int     | `10`    | Cooldown reduction per favorability level (requires favor effect) |
