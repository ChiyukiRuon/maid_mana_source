...
public class MemoryModuleRegistry {
    ...
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<ScannedSourceListMemory>> SCANNED_SOURCE_LIST =
            REGISTER.register("scanned_source_list", () -> new MemoryModuleType<>(Optional.of(ScannedSourceListMemory.CODEC)));
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<ChargeSourceListMemory>> CHARGE_SOURCE_LIST =
            REGISTER.register("charge_source_list", () -> new MemoryModuleType<>(Optional.of(ChargeSourceListMemory.CODEC)));
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<Integer>> CHARGE_INDEX =
